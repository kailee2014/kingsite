package com.blooms.kingsite.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.blooms.kingsite.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.blooms.kingsite.modules.sys.entity.User(null, userId)))){
